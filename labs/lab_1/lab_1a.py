...
This is to simulate a change made on the robot: robot speed 8 #m/s
"""

def main():
    print("Hello World and Planet!")

    name = "Saketh Tammisetti" # TODO: Insert your name between the double quotes
